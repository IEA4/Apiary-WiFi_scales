...
ЕСЛИ БЫЛ ОТКРЫТ МОНИТОР ПОРТА, ЗАКРЫТЬ. ЗАГРУЗИТЬ СКЕТЧ, ПЕРЕЗАГРУЗИТЬ,
ЗАЛИТЬ ФАЙЛ В ФЛЭШ-ПАМЯТЬ (ИНСТРУМЕНТЫ --> ESP8266 LittleFS Data Upload). ПИН GPIO16 СОЕДИНИТЬ С ПИНОМ RST
